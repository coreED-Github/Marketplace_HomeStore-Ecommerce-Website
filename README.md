...
## *CSV Testing Report Link*

https://github.com/coreED-Github/Marketplace_HomeStore-Ecommerce-Website/blob/main/CSV%20(Testing).pdf
...
## Overview
On Day 6, I focused on preparing my marketplace for deployment. This involved setting up a staging environment and configuring hosting platforms to ensure the application is ready for a customer-facing launch. Additionally, I delved into industry-standard practices for managing different environments like non-production (TRN, DEV, SIT) and production (UAT, PROD, DR).

## Step 1: Hosting Platform Setup
### 1. Choose a Hosting Platform:
I selected *Vercel* for quick deployment as it integrates seamlessly with *Next.js. Though platforms like **AWS* or *Azure* could be used for more advanced configurations, *Vercel* was ideal for this project.

### 2. Connect Repository:
I linked my *GitHub repository* to *Vercel* and configured the build settings to ensure proper deployment. Deployment scripts were specified to build and deploy the project automatically whenever changes were pushed to the repository.

## Step 2: Configure Environment Variables
### 1. Create a .env File:
I created a .env file in the root directory of my project to securely store sensitive variables, such as API keys and tokens. The following variables were added to the .env file:

---
### 2. Upload Variables to Hosting Platform:
I uploaded the environment variables to the hosting platform's dashboard, ensuring secure storage and accessibility during deployment.

## Step 3: Deploy to Staging

### 1. Deploy Application:
I deployed my marketplace application to a staging environment using *Vercel*. This allowed me to test the app in a production-like setup, ensuring readiness for real-world scenarios before going live.

### 2. Validate Deployment:
After deploying, I ensured the build process completed without errors. I reviewed the build logs and confirmed everything processed smoothly. Then, I verified the basic functionality in the staging environment by checking features like product listings, navigation, cart functionality, and user interactions.

## Step 4: Staging Environment Testing
### 1. Testing Types:
- *Functional Testing*: Verified core features of the marketplace, including product listing, search functionality, and cart operations.
- *Performance Testing: Used **Lighthouse* and *GTmetrix* to analyze speed and responsiveness, assessing metrics like *FCP, **LCP, **TBT, and **CLS*.
- *Security Testing*: Validated input fields, ensured HTTPS usage for secure connections, and checked the security of API communications.

### 2. Test Case Reporting:
I documented all test cases in a *CSV file*, which included details like Test Case ID, Description, Steps, Expected Result, Actual Result, Status, and Remarks to track the testing process.

### 3. Performance Testing:
I submitted the performance report, generated by tools like *Lighthouse, to my **GitHub repository* for transparency and sharing the performance analysis results.

## Key Tasks Completed:
1. *Deployed the Staging Environment*: Set up a fully functional staging environment for the marketplace.
2. *Configured Environment Variables*: Ensured secure environment variables to ensure smooth operation in a production-like environment.
3. *Test Case and Performance Reports*: Documented comprehensive test case and performance reports.
4. *Organized GitHub Repository: Organized all project files and documentation in a **GitHub repository* for easy access and version control.
5. *Professional README.md: Created a professional **README.md* file that summarizes the project activities and results.

---

## *Documentation Link Day 06*

https://github.com/coreED-Github/Marketplace_HomeStore-Ecommerce-Website/blob/main/Docoument%20Day%206.pdf
...
## Vercel Link
http://marketplace-home-store-ecommerce-website.vercel.app

## GitHub Repo
https://github.com/coreED-Github/Marketplace_HomeStore-Ecommerce-Website.git

##  LinkDin Profile Link

https://www.linkedin.com/in/saira-nasir-935bb1230?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app
